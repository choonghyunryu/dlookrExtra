...
cap_left <- "Data Structures"
cap_right <- "Data Types"
...
if (NROW(tab_warning) > 0) {
  ...
  print_tab(tab_warning, caption = cap, n_rows = 25)
} else {
  cat("No warnings in dataset and variables")
  break_page_asis()
}
```
...
```{r missing-viz, dpi=300, fig.height=10, fig.width=10, results='asis'}
